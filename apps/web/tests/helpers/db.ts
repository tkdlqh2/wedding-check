...
export async function resetDb() {
  ...
  await db.execute(
    sql`TRUNCATE TABLE variable_cases, feedback, checklist_instance_items, checklist_instances, ceremonies, demo_videos, checklist_template_items, halls, session, account, verification, "user" RESTART IDENTITY CASCADE`,
  );
}
